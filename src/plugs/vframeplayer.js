    ...
    play    : function (start, end, options) {
        ...
        for (var i in arguments) {
            ...
            case "number" :
                ...
                break;
            case "object" :
                if (arguments[i].onComplete) {
                    onComplete = arguments[i].onComplete;
                }
                delete arguments[i].onComplete;
                if (arguments[i].onUpdate) {
                    onUpdate = arguments[i].onUpdate;
                }
    ...
    _process: function (onUpdate, onComplete) {
        ...
        this._interval = setInterval(function () {
            if ((_this._imgObjArr[_this.curFrame] || {}).complete) {
                ...
                if (onUpdate) {
                    onUpdate(_this.curFrame, _this._times + 1, _this._asc);
                }
