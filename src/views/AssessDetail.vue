    ...
    <div class="content" v-if="isFinished">
        <div v-if="xianshi1">
            <div class="content_top">
                <div></div>
                <div>
                    <el-button type="primary" @click="printPreview" icon="el-icon-reading" style="background-color: #1E87F0; border-color: #1E87F0;">
                        打印预览
                    </el-button>
                    <el-button type="primary" v-print="printObj" icon="el-icon-printer" style="background-color: #1E87F0; border-color: #1E87F0;">
                        打印
                    </el-button>
                    <el-button type="warning" @click="dialogPrint = true" icon="el-icon-s-tools" style="background-color: #32D296; border-color: #32D296;">
                        打印设置
                    </el-button>
                    <el-button class="pink" style="color: #1E86EF" plain @click="$router.go(-1)" icon="el-icon-arrow-left">
                        返回主页面
                    </el-button>
                </div>
            </div>
                ...
                <div class="print-html" ref="print" id="print">
                    ...
                    <div class="print-body">
                            ...
                            <div class="charts-16pf" ref="pf16" v-if="infoData && infoData.calc_name === '16PF'">
                                <table>
                                    ...
                                    <tr v-for="(socre, index) in infoData.extend.socre">
                                        ...
                                        <td align="center" style="color: #1E86EF"><strong>{{ socre }}</strong></td>
                        ...
                        <template v-if="infoData.calc_name !== 'MMPICT'">
                            ...
                            <div class="print-row" :class="printData[2].value ? '' : 'print-none'"
                                 v-else-if="infoData.calc_name === 'IPSSSA71'">
                                <div class="title">IPSSSA-71因子原始分和T分</div>
                                <el-table header-row-class-name="scl90-table-header" stripe :data="infoData.extend.table1">
                                    <el-table-column prop="name" label="因子类别"></el-table-column>
                                    <el-table-column prop="origin_score" label="原始分" align="center"
...
<!--                                        <span style="display: inline-block;"></span>-->
                            ...
                            <div class="print-row" :class="printData[2].value ? '' : 'print-none'"
                                 v-if="infoData.calc_name === 'SCL90' || infoData.calc_name === 'IPSSSA71'">
...
.charts-16pf-line {
    position: absolute;
    background-image: linear-gradient(to right, #1E87F0, #b293fb);
    height: 1px;
    z-index: 1;
}
