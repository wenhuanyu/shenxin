<template>
  <div>
    <Table :page-footer="true" add-href="/AddPatient"
           :deleteUrl="'api/patient/delete'" detail-href="AddPatient"
           @remove="removeBtn" :search-url="url"
           :tableTitle="tableTitle" @delinfo="delinfoChange"
           ref="table"
    />
