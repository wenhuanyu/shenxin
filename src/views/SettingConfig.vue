<template>
    <div class="content">
        <div class="content_top">
            <a class="report" href="javascript:;"  style="color: #1E86EF" @click="beifen">
        ...
        <el-dialog :visible.sync="qrDialog" :modal="false" width="22vw" top="25vh" :close-on-click-modal="false">
            <div class="dialog-body">
                <div class="dialog-text" style="text-align: center">
                    ...
                    <el-button type="warning" style="background: #1E86EF;border: 1px solid #1E86EF;color: #FFFFFF;box-shadow:none;" round @click="qrDialog = false">知道了
                    </el-button>
                </div>
            </div>
